...
**Midnight School** é um serious game digital feito em **GameMaker** para a disciplina **Resolução de Problemas Multivariáveis**. O projeto combina exploração top-down, escape room, puzzles matemáticos, tutorias contextualizadas e batalhas em turnos no estilo JRPG para ensinar e reforçar conteúdos de cálculo multivariável.
...
| Recurso | Uso no jogo | Autor/fonte/licença |
| --- | --- | --- |
| `snd_menu_theme` | Tela inicial e menu. | A confirmar. |
| `snd_background_theme` | Salas de exploração. | A confirmar. |
| `snd_battle_theme` | Batalha do Monitor Sem Rosto. | README anterior citava “DOE DEER” — Che; confirmar fonte, licença e link. |
| `snd_battle_theme_02` | Batalha da Aluna da Janela. | A confirmar. |
| `snd_battle_theme_03` | Batalha do Cartógrafo. | A confirmar. |
| `snd_battle_theme_04` | Batalha de Isiaha. | A confirmar. |
| `snd_battle_theme_booly` | Batalha secreta do Booly. | A confirmar. |

Antes da entrega final, preencher autor, fonte, licença e link de todos os assets visuais e sonoros.

---

## 12. Testes externos e relatório

A lauda exige uma rodada de testes com público externo. Para fechar a entrega, preparar:

1. versão jogável do projeto ou executável;
2. formulário de feedback;
3. sessão com pelo menos um professor do CESUPA e outros testadores externos;
4. registros da sessão, como respostas do formulário e/ou fotos;
5. relatório sintetizando feedbacks, problemas encontrados e melhorias feitas depois dos testes.

Sugestões de perguntas para o formulário:

- Você entendeu qual conceito matemático estava sendo trabalhado em cada fase?
- As dicas ajudaram sem entregar a resposta rápido demais?
- O combate reforçou o que foi aprendido na sala?
- A dificuldade estava baixa, adequada ou alta?
- Em algum momento você ficou preso sem entender o que fazer?
- O jogo foi engajante o suficiente para continuar jogando?
- Que melhoria você sugeriria para a próxima versão?

---

## 13. Entregáveis recomendados

Para a apresentação final, preparar:

| Entregável | Conteúdo esperado |
| --- | --- |
| Jogo funcional | Projeto GameMaker com código-fonte e/ou executável exportado. |
| Documentação técnica | Este README, explicando como rodar, estrutura, objetos principais e mecânicas. |
| Explicação matemática | Mostrar onde aparecem funções, derivadas parciais, gradiente e Hessiana. |
| Relatório de testes | Formulários respondidos, registros e melhorias implementadas após os testes. |
| Apresentação oral | Demonstração prática em até 15 minutos. |

Roteiro curto sugerido para demonstração:

1. abrir a tela inicial e escolher dificuldade;
2. mostrar uma sala de exploração;
3. errar uma questão para exibir dica progressiva;
4. acertar o puzzle e abrir a porta;
5. entrar em batalha e usar Atacar/Revisar/Dica;
6. abrir o menu do jogador para mostrar Itens e Caderno;
7. explicar como as quatro fases cobrem os quatro conceitos obrigatórios.

---

## 14. Pendências antes da entrega final

- Realizar a rodada de testes externos.
- Montar o relatório de testes com feedbacks e melhorias implementadas.
- Confirmar autores, fontes, links e licenças dos sprites e músicas.
- Preencher os nomes da equipe.
- Se necessário, exportar executável Windows.
- Revisar o nome exibido nas opções Windows do projeto, pois o display name interno ainda está como `NO NAME AT MOMENT`.
- Fazer uma passada final de balanceamento no Modo Difícil e no Modo Booly.
...
- Lauda da disciplina: **Projetão Serious Game**, Resolução de Problemas Multivariáveis, Centro Universitário do Pará.
- Documento-guia do projeto: **Serious Game Multivariável — escape room com combate JRPG em turnos**.
